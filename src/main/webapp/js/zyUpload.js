		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '					是否公开相册:<label><input name="private_input" type="radio" value="Y" checked/>是</label> ';
		            html += '					<input class="isprivate" type="radio"  name="private_input" value="N"/>否';
	            	html += '					</div>';
	            	html += '				</div>';
	            	html += '				<span id="fileDragArea" class="upload_drag_area" style="border:0 solid transparency"></psan>	'
		            ...
		            html += '				<div class="btns">';
		            html += '					<input id="fileImage" type="file" size="30" name="fileselect[]" '+multiple+'>';
		            html += '					是否公开相册:<label><input name="private_input" type="radio" value="Y" />是</label> ';
		            html += '					<input class="isprivate" type="radio"  name="private_input" value="N"/>否';
				    ...
				    html += '							<img class="upload_image" src="img/images/add_img.png" style="width:expression(this.width > '+imgWidth+' ? '+imgWidth+'px : this.width)" />';
				    html += '						</div>';
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				// 处理不同类型文件代表的图标
				var fileImgSrc = "/img/images/fileType/";
